# Change Log Archive — 2026 (Jan–Apr)

> Archived from `_blog/change-log.md` on 2026-07-14 when the live log exceeded the 50-row threshold.
> Rows below are frozen — do not append here; new entries go in the live `change-log.md`.
