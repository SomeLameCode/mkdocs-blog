...
| SI-012 | Add Google Search Console verification file | Low | S | Low | [x] | 2026-07-14 | `docs/google7edd60ce4d78d84d.html` (site owner started GSC property setup, dropped the verification file in `temp/`, copied to `docs/` to publish at site root); site owner still needs to click Verify in the GSC console and submit the sitemap once deployed. Bing Webmaster Tools import/verification still pending (manual, site owner); from execution plan Item 8 |
