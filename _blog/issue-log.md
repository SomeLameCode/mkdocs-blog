...
| 2026-04-20 | Dead anchor in m365-tenant-separation.md | `docs/projects/m365-tenant-separation.md` contains a link to `#2-business-context--the-forced-cutover` but no such anchor exists on the page — flagged by MkDocs on every deploy | Fix or remove the anchor link | |
